...
const MenuOrder = ({ menuImg }) => {
    return (
        <div className="w-full mt-20 lg:mt-24 lg:flex items-stretch gap-8 px-6 lg:px-12 font-poppins mb-20 lg:mb-12">
            {/* Left section */}
            ...
            <div className="lg:w-1/2 w-full mt-8 lg:mt-0 flex flex-col justify-between">
                ...
                <div className="space-y-4 mt-8 lg:mt-10">
                    ...
                    <Link to="/order">
                        <button className="relative mt-4 px-6 py-3 font-bold text-white border-2 border-transparent bg-orange-600 hover:bg-transparent hover:border-orange-600 hover:text-orange-600 transition-all duration-300 rounded-full shadow-lg">
                            Order Now
                        </button>
                    </Link>
                </div>
